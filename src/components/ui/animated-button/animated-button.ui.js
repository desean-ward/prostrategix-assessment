...
const AnimatedButton = () => {
  return (
    <button className='relative inline-flex h-12 overflow-hidden rounded-lg p-[1px] focus:outline-none shadow-lg shadow-black'>
      ...
      <span className='inline-flex items-center justify-center w-full h-full px-3 py-1 text-xl font-medium text-white rounded-lg cursor-pointer rou bg-slate-950 hover:bg-slate-800 backdrop-blur-3xl'>
        Enter
      </span>
    </button>
  );
